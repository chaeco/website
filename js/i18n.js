const translations = {
    en: {
        ...
        repo_iplookup_title: "IP Lookup",
        repo_iplookup_desc: "Unified IP lookup plugin with 8 rotating public providers, normalized results, and proxy/VPN/Tor detection.",
    ...
    zh: {
        ...
        repo_iplookup_title: "IP Lookup",
        repo_iplookup_desc: "统一 IP 查询插件，8 个公共源自动轮转容错，返回归一化结果，支持代理 / VPN / Tor 检测。",
        repo_sqlo_title: "Sqlo",
